...
ROLL the dice and apply the results or use point buy (enable STATS to see the current point buy value).
Choose a race and click ADD TRAITS.
...
On page 2, add items to your inventory with ADD ITEMS AND SPELLS, ADD ITEMS, ALL OF THE ABOVE. Manually add any other equipment granted by your class.
